    ...
    <header className="fixed top-4 inset-x-4 sm:top-5 sm:inset-x-8 lg:inset-x-16 z-50">
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-[13.5px] font-bold transition-transform hover:scale-105"
...
// ---------------------------------------------------------------------------
// Hero — dark navy, headline + CTA, animated dashboard-preview mockup
// ---------------------------------------------------------------------------
...
function DashboardMockup() {
  return (
    <div
      ...
      style={{ background: "rgba(255,255,255,0.03)", borderColor: "rgba(255,255,255,0.1)", boxShadow: "0 30px 80px rgba(0,0,0,0.35)" }}
    >
      {/* window chrome */}
      ...
      <div className="p-4 sm:p-6 grid grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="col-span-2 flex flex-col gap-2.5">
          ...
          {[
            { label: "Design new logo", tag: "Design", tagColor: "#A1C2BD", pct: 70 },
            { label: "Ship pricing page", tag: "Urgent", tagColor: "#F0A56B", pct: 30 },
            { label: "Client onboarding call", tag: "Today", tagColor: "#8BAAA6", pct: 90 },
          ].map((row) => (
            <div key={row.label} className="flex items-center gap-3 rounded-xl px-3 py-2.5" style={{ background: "rgba(255,255,255,0.04)" }}>
              <span className="w-4 h-4 rounded-md flex-shrink-0" style={{ border: "1.5px solid rgba(255,255,255,0.25)" }} />
          ...
          <div className="mt-1 flex items-start gap-2.5 rounded-xl px-3 py-2.5" style={{ background: "rgba(206,126,55,0.1)", border: "1px solid rgba(206,126,55,0.25)" }}>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="flex-1 rounded-xl px-3 py-3 flex flex-col items-center justify-center gap-1" style={{ background: "rgba(255,255,255,0.04)" }}>
            <div className="w-12 h-12 rounded-full" style={{ background: "conic-gradient(#CE7E37 0% 65%, rgba(255,255,255,0.08) 65% 100%)" }} />
...
function Hero() {
  ...
  return (
    ...
    >
      {/* ambient glows */}
      <div className="pointer-events-none absolute -top-24 -left-24 w-96 h-96 rounded-full blur-3xl opacity-20" style={{ background: "#CE7E37" }} />
      <div className="pointer-events-none absolute top-40 -right-32 w-[28rem] h-[28rem] rounded-full blur-3xl opacity-[0.12]" style={{ background: "#A1C2BD" }} />
      ...
      <div className="relative max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        >
          <Sparkles className="w-3 h-3" /> Now with Ask Tasko, your built-in AI teammate
        </motion.div>
        ...
        >
          Task management that actually{" "}
          <span style={{ color: "#CE7E37" }}>keeps up</span> with your team.
        </motion.h1>
        ...
        >
          <Link
            href="/register"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-[14.5px] font-bold transition-transform hover:scale-105"
...
// ---------------------------------------------------------------------------
// Ask Tasko spotlight — mock chat conversation animating in
// ---------------------------------------------------------------------------
...
function AiSpotlight() {
  return (
    <section id="ai" className="relative py-24 sm:py-32 px-6 overflow-hidden" style={{ background: "#19183B" }}>
      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[36rem] h-[36rem] rounded-full blur-3xl opacity-[0.08]" style={{ background: "#CE7E37" }} />
      ...
      <div className="relative max-w-5xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        ...
        >
          <div className="flex items-center gap-2 pb-3 border-b" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
            <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{ background: "#CE7E37" }}>
  ...
  return (
    <section id="about" className="relative py-24 sm:py-32 px-6" style={{ background: "var(--page-bg)" }}>
      <motion.div
        ...
        viewport={{ once: true, margin: "-80px" }}
        variants={fadeUp}
        className="max-w-3xl mx-auto text-center rounded-3xl px-8 py-16 sm:py-20"
        style={{ background: "#19183B" }}
      >
        <h2 className="text-[28px] sm:text-[38px] font-bold leading-tight text-white" style={{ fontFamily: "var(--font-display)" }}>
          Ready to get your team organized?
        </h2>
        <p className="mt-4 text-[15px] max-w-md mx-auto" style={{ color: "rgba(255,255,255,0.6)" }}>
          Set up your workspace in minutes — projects, chat, and Ask Tasko, ready to go.
        </p>
        <Link
          href="/register"
          className="mt-8 inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-[15px] font-bold transition-transform hover:scale-105"
          style={{ background: "#CE7E37", color: "white", boxShadow: "0 8px 24px rgba(206,126,55,0.35)" }}
        >
          Join Now <ArrowRight className="w-4 h-4" />
        </Link>
...
function Footer() {
  return (
    <footer className="px-6 py-10" style={{ background: "var(--page-bg)" }}>
